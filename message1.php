...
<a href='notification.php?msgid=<?php echo $row["id"];?>&&to=<?php echo $row["from"];?>&&`from`=<?php echo $row["to"]?>'><u>View</u></a></center></td></tr></table>
<?php } ?>
...
if (isset($_GET["msgid"])) {
			...
			$sql=mysql_query("select * from `message` where id=".$_GET["msgid"]);
           while($row=mysql_fetch_array($sql)){		echo "<table class='table-condensed' width='750%' border=2 align='left'><tr><td width=200px>
<font color='white'>$row[msg]<br></td><td> 
    
           <a href='image/$row[img1]'> Download</a></td></tr></table></font>";}
		    ...
		    ?></div></div><div class="col-md-12"><div class="col-md-3"></div><div class="col-md-3"></div><div class="col-md-3"><font color="black"><br><br><form method="get">
		    	<input type="hidden" name="id" value="<?php echo $_GET["to"]; ?>">
